...
vignette: >
  %\VignetteIndexEntry{How to run the analysis}
...
The vignettes describes how to fit a random forest model to a bootstrap sample of the original dengue FOI dataset, making predictions, estimating burden and predicting the impact of a general transmission reducing intevention and the Sanofi Pasteur dengue vaccine. To reduce computation time we do the intervention impact analysis for Brazil only.

## Making FOI predictions

We first define some parameters and variables 
...
We fit a RF model to a bootstrap sample of the data and make predictions 
...
# keep only pixels in Brazil as an example
...
We generate a map of the FOI predictions with the following
...
## Estimating R0 and baseline burden
...
## Impact of a transmission reducing intervention
...
## Impact of the Sanofi Pasteur vaccine
